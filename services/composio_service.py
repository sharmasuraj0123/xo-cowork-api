...
TOOLKITS: dict[str, ToolkitMeta] = {
    ...
    "instagram":       ToolkitMeta("INSTAGRAM",       "Instagram",        ("OAUTH2",),            {"OAUTH2": "COMPOSIO_AUTH_CONFIG_INSTAGRAM"}),
    "linkedin":        ToolkitMeta("LINKEDIN",        "LinkedIn",         ("OAUTH2",),            {"OAUTH2": "COMPOSIO_AUTH_CONFIG_LINKEDIN"}),
    "twitter":         ToolkitMeta("TWITTER",         "Twitter / X",      ("OAUTH2",),            {"OAUTH2": "COMPOSIO_AUTH_CONFIG_TWITTER"}),
    "reddit":          ToolkitMeta("REDDIT",          "Reddit",           ("OAUTH2",),            {"OAUTH2": "COMPOSIO_AUTH_CONFIG_REDDIT"}),
    "shopify":         ToolkitMeta("SHOPIFY",         "Shopify",          ("OAUTH2",),            {"OAUTH2": "COMPOSIO_AUTH_CONFIG_SHOPIFY"}),
    "excel":           ToolkitMeta("EXCEL",           "Excel",            ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_EXCEL"}),
    "elevenlabs":      ToolkitMeta("ELEVENLABS",      "ElevenLabs",       ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_ELEVENLABS"}),
    "figma":           ToolkitMeta("FIGMA",           "Figma",            ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_FIGMA"}),
    "cloudflare":      ToolkitMeta("CLOUDFLARE",      "Cloudflare",       ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_CLOUDFLARE"}),
    "clickup":         ToolkitMeta("CLICKUP",         "ClickUp",          ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_CLICKUP"}),
    "apollo":          ToolkitMeta("APOLLO",          "Apollo",           ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_APOLLO"}),
    "dropbox":         ToolkitMeta("DROPBOX",         "Dropbox",          ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_DROPBOX"}),
    "coinbase":        ToolkitMeta("COINBASE",        "Coinbase",         ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_COINBASE"}),
    "posthog":         ToolkitMeta("POSTHOG",         "PostHog",          ("API_KEY",),           {"API_KEY": "COMPOSIO_AUTH_CONFIG_POSTHOG"}),
}
